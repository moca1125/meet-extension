...
(function (global, factory) {
    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3:
                        ...
                        _g.label = 4;
                    case 4:
                        faceMesh = new MediaPipeFaceMesh(models[0], models[1], maxContinuousChecks, detectionConfidence, maxFaces, shouldLoadIrisModel ? models[2] : null);
    ...
    var MediaPipeFaceMesh = /** @class */ (function () {
        function MediaPipeFaceMesh(blazeFace, blazeMeshModel, maxContinuousChecks, detectionConfidence, maxFaces, irisModel) {
        ...
        MediaPipeFaceMesh.getAnnotations = function () {
         ...
         */
        MediaPipeFaceMesh.getUVCoords = function () {
            return UV_COORDS;
        };
        /**
         ...
         */
        MediaPipeFaceMesh.prototype.estimateFaces = function (config) {
            return __awaiter(this, void 0, void 0, function () {
    ...
    var FaceLandmarksPackage = /** @class */ (function () {
        function FaceLandmarksPackage() {
        }
        // Returns an array of faces in an image.
        FaceLandmarksPackage.prototype.estimateFaces = function (config) {
            throw new Error('estimateFaces is not yet implemented.');
        };
        return FaceLandmarksPackage;
    }());
